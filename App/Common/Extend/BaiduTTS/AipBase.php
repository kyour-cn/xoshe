...
* the License.
*/
namespace App\Common\Extend\BaiduTTS;
...
class AipBase {
    ...
    private function getAuthFilePath(){
        $dir = EASYSWOOLE_ROOT . DIRECTORY_SEPARATOR . 'Temp' . DIRECTORY_SEPARATOR . 'BaiduTTS';
        if (!file_exists($dir)){
            mkdir ($dir,0777,true);
        }
        return $dir . DIRECTORY_SEPARATOR . md5($this->apiKey);
    }
